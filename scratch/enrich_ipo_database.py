...
ALL_INDIAN_IPOS: List[Dict[str, Any]] = [
    # --- ACTIVE / LIVE BIDDING IPOS ---
    {
        ...
        "subscription": {
            ...
            "dayBreakdown": [
                {"day": "Day 1 (25-Aug)", "qib": "1.40x", "nii": "6.80x", "retail": "4.10x", "total": "3.85x", "status": "Strong Day 1 Surge"}
            ]
        },
        ...
        "recommendation": {
            ...
            "recommendedStrategy": "India's 2nd largest integrated solar cell and module manufacturer. Massive ₹330 GMP (+73.3%) backed by marquee anchor institutional backing. Strong apply for bumper listing gains.",
        ...
        "pros": ["86.1% 3-year revenue CAGR", "Top-tier GMP of ₹330 (+73.3%)", "Anchor book with ADIA, BlackRock, and SBI MF"],
        "cons": ["Raw material dependency on imported polysilicon wafers"]
    },
    {
        "id": "IPO-ECOSMOB",
        "symbol": "ECOSMOB",
        ...
        "businessOverview": {
            "whatTheCompanyDoes": "ECOS Mobility is India's largest chauffeur-driven car rental (CCR) and corporate employee transportation service (ETS) provider across 109 cities."
        },
        "pros": ["Zero net debt with 42.8% RoNW", "Deep Fortune 500 enterprise relationships", "Strong ₹160 GMP (+47.9%)"],
        "cons": ["100% OFS issue"]
    },
    {
        "id": "IPO-INPHOS",
        ...
        "sector": "Single Super Phosphate (SSP) Fertilizers & Chemicals",
        "category": "NSE SME",
        "market": "IN",
        "openDate": "2026-08-25",
        ...
        "subscription": {
            ...
            "nii": 22.40,
            "retail": 15.60,
            "sharesOffered": "68,04,000",
            "sharesBid": "10,06,99,200",
            "totalAmountBidCr": 996.92,
            "demandStatus": "🔥 100%+ SME MULTIBAGGER GMP"
        },
        "aiVerdict": "STRONG_APPLY_HIGH_GAIN",
        "aiVerdictLabel": "🚀 SME 2x Listing Pick (GMP +105%)",
        "aiScore": 92,
        "rating": "4.6 / 5.0",
        "recommendation": {
            "verdict": "APPLY AT UPPER BAND (₹99)",
            "targetListingPrice": "₹195 - ₹215 (+97% to +117%)",
            "recommendedStrategy": "High-growth SSP fertilizer producer with expanding chemical lines. 100%+ GMP indicates massive listing upside.",
            "investorSuitability": "High Networth SME Investors",
            "riskGrade": "MODERATE"
        },
        "businessOverview": {
            "whatTheCompanyDoes": "Indian Phosphate manufactures Single Super Phosphate (SSP), Granulated Single Super Phosphate (GSSP), and LABSA chemical compounds for agricultural cooperatives."
        },
        "pros": ["105% GMP in grey market", "100% fresh issue funding capacity doubling"],
        "cons": ["SME lot size is ₹1.19 Lakhs"]
    },
    {
        "id": "IPO-JAYBEE",
        "symbol": "JAYBEE",
        ...
        "subscription": {
            ...
            "nii": 12.80,
            "retail": 9.20,
            "sharesOffered": "60,93,000",
            "sharesBid": "5,11,81,200",
            "totalAmountBidCr": 747.24,
            "demandStatus": "🔥 POWER CAPEX THEMATIC PLAY"
        },
        "aiVerdict": "STRONG_APPLY_HIGH_GAIN",
        "aiVerdictLabel": "🚀 Power Sector Supercycle (+82% GMP)",
        "aiScore": 90,
        "rating": "4.5 / 5.0",
        "recommendation": {
            "verdict": "APPLY AT CUT-OFF (₹146)",
            "targetListingPrice": "₹250 - ₹275 (+71% to +88%)",
            "recommendedStrategy": "Direct beneficiary of India's grid transformer modernization and renewable power transmission buildout.",
            "investorSuitability": "SME & Power Sector Growth Investors",
            "riskGrade": "MODERATE"
        },
        "businessOverview": {
            "whatTheCompanyDoes": "Jay Bee Laminations manufactures CRGO (Cold Rolled Grain Oriented) silicon steel cores, transformer laminations, and slit coils for electrical utility OEMs."
        },
        "pros": ["Surging transformer demand from power grid expansion", "82.2% GMP margin of safety"],
    ...
    # --- CLOSED / ALLOTMENT STAGE IPOS ---
    {
        ...
        "subscription": {
            ...
            "demandStatus": "🔥 151.7x COLOSSAL DEMAND (CLOSED)"
        },
        "aiVerdict": "APPLY_FOR_LISTING",
        "aiVerdictLabel": "🚀 Blockbuster Listing Pop (+37.9% GMP)",
        "aiScore": 91,
        "rating": "4.5 / 5.0",
        "recommendation": {
            "verdict": "CLOSED — AWAIT ALLOTMENT (LISTING AUG 28)",
            "targetListingPrice": "₹280 - ₹295 (+36% to +43%)",
            "recommendedStrategy": "Bidding closed with 151.7x oversubscription. Check allotment status on Link Intime.",
            "riskGrade": "LOW_MODERATE"
        },
        "businessOverview": {
            "whatTheCompanyDoes": "Orient Technologies is an IT infrastructure and multi-cloud solutions specialist delivering Data Center Virtualization, Cybersecurity, and Managed Services."
        },
        "pros": ["151.7x oversubscribed momentum", "17.5x P/E valuation discount vs 32x peer average"],
        "cons": ["Working capital cycle"]
    },
    {
        "id": "CLOSED-IDEAL",
        "symbol": "IDEAL",
        "companyName": "Ideal Technoplast Industries Limited",
        "sector": "Industrial Plastic Packaging & Rigid Containers",
        "category": "NSE SME",
        "market": "IN",
        "openDate": "2026-08-21",
        "closeDate": "2026-08-23",
        ...
        "maxPrice": 121.0,
        "lotSize": 1000,
        "minInvestment": 121000.0,
        "issueSizeCr": 16.03,
        "freshIssueCr": 16.03,
        "ofsCr": 0.0,
        "gmp": 48.0,
        "gmpPercent": 39.67,
        "expectedListingPrice": 169.0,
        "allotmentStatus": "⏳ ALLOTMENT IN PROGRESS (BIGSHARE)",
        "subscription": {
            "total": 116.40,
            "qib": 42.10,
            "nii": 215.80,
            "retail": 98.60,
            "demandStatus": "🔥 116x OVERSUBSCRIBED"
        },
        "aiVerdict": "APPLY_FOR_LISTING",
        "aiVerdictLabel": "✅ SME Listing Gain (~+40%)",
        "aiScore": 84,
        "rating": "4.2 / 5.0",
        "recommendation": {
            "verdict": "CLOSED — LISTING AUG 28",
            "targetListingPrice": "₹165 - ₹175 (+36% to +45%)",
            "recommendedStrategy": "Bidding closed with 116x demand. Solid listing day profit expected.",
            "riskGrade": "MODERATE"
        },
        "businessOverview": {
            "whatTheCompanyDoes": "Ideal Technoplast manufactures rigid plastic packaging containers, drums, and jerry cans for paints, chemicals, and FMCG sectors."
        }
    },
    ...
    },
    {
        ...
        "sector": "Precision Fin & Tube Heat Exchangers for HVAC & EV",
        "category": "Mainboard",
        "market": "IN",
        "openDate": "2026-09-25",
    ...
    },
    {
        ...
        "sector": "Premium Residential Real Estate & Redevelopment",
        "category": "Mainboard",
        "market": "IN",
        "openDate": "2026-09-16",
        ...
        "expectedGmp": "+₹60 (+46.8%)",
        "gmpPercent": 46.87,
        "expectedListingPrice": 188.0,
        "expectedDate": "Sep 16 - Sep 19, 2026",
        "drhpStatus": "📋 RHP FILED (100% PRIMARY)",
        "aiOutlook": "Mumbai MMR premium redevelopment player with fast turnaround times and high project IRR.",
        "aiVerdict": "APPLY_FOR_LISTING",
        "aiVerdictLabel": "🚀 High Listing Pop (+46.8% GMP)",
        "aiScore": 86,
        "rating": "4.3 / 5.0",
        "businessOverview": {
            "whatTheCompanyDoes": "Arkade Developers develops high-end residential towers and gated communities across Mumbai MMR."
        }
    },
    ...
    # --- RECENTLY LISTED IPOS ---
    {
        ...
        "status": "STRONG LISTING (+44.3% GAIN)"
    },
    {
        "id": "LIST-FIRSTCRY",
        "symbol": "FIRSTCRY",
    ...
    },
    {
        "id": "LIST-SARASWATI",
        "symbol": "SARASWATI",
        "companyName": "Saraswati Saree Depot Limited",
        "sector": "Apparel & Ethnic Saree Wholesale",
        "listingDate": "2026-08-20",
        "issuePrice": 160.0,
        "listingPrice": 200.0,
        "listingGainPercent": 25.00,
        "currentPrice": 192.50,
        "totalReturnPercent": 20.31,
        "issueSizeCr": 160.0,
        "subscriptionTotal": "107.5x",
        "status": "HEALTHY 25% LISTING GAIN"
    }
]
