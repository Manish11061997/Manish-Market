...
const DEFAULT_RECOMMENDATIONS_IN = {
  ...
  all: [
    ...
    },
    {
      ...
      stopLoss: 920.00,
      horizon: "SWING",
      setup: "Flag & Pennant Continuation",
      catalyst: "JLR free cash flow inflection & EV market leadership",
      riskRewardRatio: "2.55:1",
      aiSummary: "Breakout on 3x average weekly volume above pivot."
    },
    {
      symbol: "SBIN.NS",
      name: "State Bank of India",
      sector: "Banking & Financials",
      currentPrice: 1060.00,
      change: 15.40,
      changePercent: 1.47,
      signal: "BUY",
      confidence: 86,
      ...
      stopLoss: 1010.00,
      horizon: "LONG_TERM",
      setup: "Stage 2 Continuation Breakout",
      catalyst: "Credit growth outperformance and low credit cost guidance",
      riskRewardRatio: "2.40:1",
      aiSummary: "Institutional block deals confirmed on daily charts."
    }
  ]
};
